  ...
  return (
      ...
      <Dialog.Portal>
        <Dialog.Overlay className='bg-black/40 inset-0 fixed' />
          <Dialog.Content className='fixed bg-[#2A2634] py-8 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 
          -translate-y-1/2 rounded-lg w-[480px]'>
            ...
            <form onSubmit={CreateAd} className='mt-8 flex flex-col gap-4'>
              ...
              <div className='grid grid-cols-2 gap-6'>
                <div className='flex flex-col gap-2'>
                  ...
                  <Input name='yearsPlaying' id='yearsPlaying' placeholder='Tudo bem ser 0' />
                </div>
              ...
              <footer className='mt-4 flex justify-end gap-4'>
                ...
                <button 
                  type='submit'
                  className='bg-violet-500 hover:bg-violet-600 px-5 h-12 rounded-mb font-semibold flex items-center gap-3' 
                >
